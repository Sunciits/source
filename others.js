...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Sunciits/source/master/lang/langIndex.json", function (json) {
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat(lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + ":heart: " + lastplay.score.grabs + "G/" + lastplay.score.negative + "M.")
                }
                else {
